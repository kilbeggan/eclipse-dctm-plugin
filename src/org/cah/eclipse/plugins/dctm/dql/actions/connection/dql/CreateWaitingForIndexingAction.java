/*-
 * $Log: CreateWaitingForIndexingAction.java,v $
 ...
 *
 * Revision 1.3  2005/02/09 14:01:29  harpechr
 * Version 1.0.5 work started.
 *
 * Revision 1.2  2005/02/07 12:37:35  harpechr
 * Create fulltext indexed DQL action added.
 *
 * Revision 1.1  2005/02/07 11:03:54  harpechr
...
/**
 * <H4>Create waiting for indexing DQL statement.</H4>
 * <DL>
 * <DT><B>Copyright : </B>
 ...
 * @since 1.0.4
 */
public class CreateWaitingForIndexingAction
											extends
												AbstractCreateDQLAction
{

	/**
	 * Key to return waiting for indexing DQL.
	 * 
	 * @since 1.0.4
	 */
	...
	/**
	 * Key to return waiting for indexing DQL comment.
	 * 
	 * @since 1.0.4
	 */
	public static final String	MSG_WAITING_FOR_INDEXING_COMMENT	= "MSG_WAITING_FOR_INDEXING_COMMENT";	//$NON-NLS-1$
	 ...
	 * @since 1.0.4
	 */
	public CreateWaitingForIndexingAction()
	{
	...
	/**
	 * Get the waiting for indexing DQL
	 * <DL>
	 * <DT><B>Created : </B>
	 * <DD>Jan 25, 2005 2:56:13 PM</DD>
	 * </DT>
	...
	protected String getCreateDQL()
	{
		...
		final StringBuffer createCountUsersDocumentsQuery = new StringBuffer(
			AbstractCreateDQLAction
				.getResourceBundle()
				.getString(
					CreateWaitingForIndexingAction.MSG_WAITING_FOR_INDEXING_COMMENT))
			.append(AbstractCreateDQLAction.getResourceBundle().getString(
				CreateWaitingForIndexingAction.MSG_WAITING_FOR_INDEXING));
