/*-
 * $Log: CreateFormatStatisticsAction.java,v $
 ...
 *
 * Revision 1.1  2005/01/25 20:18:57  harpechr
...
/**
 * <H4>Create format statistics query.</H4>
 * <DL>
 * <DT><B>Copyright : </B>
 ...
 * @since 1.0.4
 */
public class CreateFormatStatisticsAction
											extends
												AbstractCreateDQLAction
{

	/**
	 * Key to return format statistics.
	 * 
	 * @since 1.0.4
	 */
	public static final String	MSG_CONTENT_FORMAT_STATISTICS			= "MSG_CONTENT_FORMAT_STATISTICS";			//$NON-NLS-1$

	/**
	 * Key to return format statistics comment.
	 * 
	 * @since 1.0.4
	 */
	public static final String	MSG_CONTENT_FORMAT_STATISTICS_COMMENT	= "MSG_CONTENT_FORMAT_STATISTICS_COMMENT";	//$NON-NLS-1$
	 ...
	 * @since 1.0.4
	 */
	public CreateFormatStatisticsAction()
	{
	...
	protected String getCreateDQL()
	{
		...
		final StringBuffer createFormatStatisticsQuery = new StringBuffer(
			AbstractCreateDQLAction
				.getResourceBundle()
				.getString(
					CreateFormatStatisticsAction.MSG_CONTENT_FORMAT_STATISTICS_COMMENT))
			.append(AbstractCreateDQLAction.getResourceBundle().getString(
				CreateFormatStatisticsAction.MSG_CONTENT_FORMAT_STATISTICS));
		return createFormatStatisticsQuery.toString();
	}
