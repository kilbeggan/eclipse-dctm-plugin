/*-
 * $Log: ExportResultsAction.java,v $
...
/**
 * <H4>Export all results to a file.</H4>
 * <DL>
 * <DT><B>Copyright (c): </B>
									...
									AbstractBaseAction
{
	...
	/**
	 * Select everything, launch the export dialog and return the selection.
	 * <DL>
	 * <DT><B>Created : </B>
	...
	public void run()
	{
		...
		if(getView() instanceof ResultView)
		{
			...
			if(resultView.getSelectedTable() != null)
			{
				...
				dialog.open();
				resultView.getSelectedTable().setSelection(selected);
			}
		}
	}
}
