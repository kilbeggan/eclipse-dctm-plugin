/*-
 * $Log: TBOGenerationWizard.java,v $
 ...
 * @since 1.0
 */
public class TBOGenerationWizard
								extends
									Wizard

{
	 ...
	 * @since 1.0
	 */
	private TBOGenerationPage	tBOGenerationPage	= null;
	...
	public void addPages()
	{
		...
		setGenerationPage(new TBOGenerationPage("Generate TBO classes", //$NON-NLS-1$
			"Generate BOF/TBO classes to the given location", ImageCache //$NON-NLS-1$
				.getImageDescriptor(IImageCache.EXPORT_BOF_ICON)));
		addPage(getTBOGenerationPage());
	}

	/**
	 * Create the TBO classes.
	 * <DL>
	 * <DT><B>Created : </B>
	 ...
	 * 
	 * @since 1.0
	 * @return true if the creation goes well.
	...
	public boolean performFinish()
	{
		...
		return getTBOGenerationPage().performFinish();
	}

	/**
	 * Get the generation page.
	 * <DL>
	 * <DT><B>Created : </B>
	 ...
	 */
	protected TBOGenerationPage getTBOGenerationPage()
	{

		return this.tBOGenerationPage;
	}

	/**
	 * Set the generation page.
	 * <DL>
	 * <DT><B>Created : </B>
	 ...
	 * 
	 * @since 1.0
	 * @param aTBOGenerationPage
	 *            the new page.
	 */
	protected void setGenerationPage(TBOGenerationPage aTBOGenerationPage)
	{

		this.tBOGenerationPage = aTBOGenerationPage;
	}
}
