...
/**
 * <H4>DQL editor resource bundle.</H4>
 * <DL>
 * <DT><B>Copyright (c): </B>
 ...
 * @since 1.0
 */
public class DQLEditorMessages
{
	 ...
	 * @since 1.0
	 */
	private static final String		RESOURCE_BUNDLE	= DQLEditorMessages.class
														.getName()
	...
	public static ResourceBundle getResourceBundle()
	{
		...
		if(DQLEditorMessages.resourceBundle == null)
		{
			try
			{
				DQLEditorMessages.resourceBundle = ResourceBundle
		...
		return DQLEditorMessages.resourceBundle;
	}

	/**
	 * Get a resource string from the bundle.
	 * <DL>
	 * <DT><B>Created : </B>
	...
	public static String getString(String key)
	{
		...
		try
		{
			return DQLEditorMessages.resourceBundle.getString(key);
