/*-
 * $Log: APIActionContributor.java,v $
...
/**
 * <H4>Create execute menu item.</H4>
 * <DL>
 * <DT><B>Copyright (c): </B>
 * <DD>Christopher Harper</DD>
 * </DT>
 * <DT><B>Created : </B>
 * <DD>Nov 24, 2004 4:01:11 PM.</DD>
 * </DT>
 * </DL>
 * <p>
 ...
 * @since 1.0
 */
public class APIActionContributor
									extends
										TextEditorActionContributor
{
	...
	/**
	 * Set menu and toolbar items into place.
	 * <DL>
	 * <DT><B>Created : </B>
	 * <DD>Nov 28, 2004 1:20:36 PM</DD>
	 * </DT>
	 * <DT><B>Author : </B>
	 * <DD>Christopher Harper account : HARPECHR</DD>
	 * </DT>
	...
	public void init(final IActionBars actionBars)
	{
		...
		if(toolBarManager != null)
		{
			...
			toolBarManager.add(ConnectionView.getInstance().getExecuteAction());
		}
	}
