/*-
 * $Log: DQLSourceVieweConfiguration.java,v $
 ...
 * @since 1.0
 */
public class DQLSourceVieweConfiguration
										extends
											SourceViewerConfiguration
{
	 ...
	 * @since 1.0
	 */
	private DQLColorProvider		colorManager		= null;
	 ...
	 * @since 1.0
	 */
	private DQLDoubleClickStrategy	doubleClickStrategy	= null;

	/**
	 * DQL key word scanner.
	 * 
	 * @since 1.0
	 */
	private DQLKeywordScanner		tagScanner			= null;
	 ...
	 *            the colour manager.
	 */
	public DQLSourceVieweConfiguration(DQLColorProvider colorManager)
	{
	...
	public String[] getConfiguredContentTypes(final ISourceViewer sourceViewer)
	{
		...
		return new String[] {IDocument.DEFAULT_CONTENT_TYPE,
			DQLPartitionScanner.DQL_COMMENT, DQLPartitionScanner.DQL_KEYWORD};
	}
													...
													final ISourceViewer sourceViewer)
	{
		...
		assistant.setContentAssistProcessor(new DQLCompletionProcessor(),
															...
															final String contentType)
	{
		...
		{
			setDoubleClickStrategy(new DQLDoubleClickStrategy());
		}
																...
																final ISourceViewer sourceViewer)
	{
		...
		DQLNonRuleBasedDamagerRepairer nonRuleBasedDamagerRepairer = new DQLNonRuleBasedDamagerRepairer(
			new TextAttribute(getColorManager().getColor(
				DQLColorProvider.SINGLE_LINE_COMMENT)));
	 ...
	 */
	protected DQLColorProvider getColorManager()
	{
	 ...
	 */
	protected DQLDoubleClickStrategy getDoubleClickStrategy()
	{
	 ...
	 */
	protected DQLKeywordScanner getTagScanner()
	{

		if(this.tagScanner == null)
		{
			setTagScanner(new DQLKeywordScanner(getColorManager()));
			/*
			 * tagScanner.setDefaultReturnToken(new Token(new
			 * TextAttribute(colorManager.getColor(DQLColorProvider.DEFAULT))));
			 */
		}
	 ...
	 */
	protected void setColorManager(final DQLColorProvider aColorManager)
	{
	...
	protected void setDoubleClickStrategy(
											final DQLDoubleClickStrategy aDoubleClickStrategy)
	{
	 ...
	 */
	protected void setTagScanner(final DQLKeywordScanner aTagScanner)
	{
