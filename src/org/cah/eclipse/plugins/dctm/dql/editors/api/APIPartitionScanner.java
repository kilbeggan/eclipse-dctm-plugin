/*-
 * $Log: APIPartitionScanner.java,v $
 ...
 * @since 1.0
 */
public class APIPartitionScanner
								extends
									RuleBasedPartitionScanner
{
	 ...
	 * @since 1.0
	 */
	public final static String	API_COMMENT	= "__api_comment";	//$NON-NLS-1$
	 ...
	 * @since 1.0
	 */
	public final static String	API_KEYWORD	= "__api_keyword";	//$NON-NLS-1$
	 ...
	 * @since 1.0
	 */
	public APIPartitionScanner()
	{

		final List<IRule> rules = new ArrayList<IRule>();
		final IToken sqlComment = new Token(API_COMMENT);
