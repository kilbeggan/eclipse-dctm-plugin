/*-
 * $Log: APIDocumentProvider.java,v $
...
/**
 * <H4>Shared document provider specialized for API resources.</H4>
 * <DL>
 * <DT><B>Copyright (c): </B>
 ...
 * @since 1.0
 */
public class APIDocumentProvider
								extends
	...
	protected IDocument createDocument(Object element) throws CoreException
	{
		...
		if(document != null)
		{
			...
			final IDocumentPartitioner partitioner = new FastPartitioner(
				new APIPartitionScanner(), new String[] {
					APIPartitionScanner.API_KEYWORD,
					APIPartitionScanner.API_COMMENT});
			// final IDocumentPartitioner partitioner = new
			// DefaultPartitioner(new APIPartitionScanner(), new String[] {
			// APIPartitionScanner.API_KEYWORD,
			// APIPartitionScanner.API_COMMENT});
